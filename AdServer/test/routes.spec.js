...
const PATTERN = {
  ...
  response: _.isString,
  contentCreator: _.isString,
  publicationId: _.isString,
};
...
const queryStr = `?c=1&dur=15&uid=${UID}&cc=${CC}&pi=${PI}&os=android&dt=samsung&ss=1000x200&uip=123.123.123.123`;
  ...
  describe("GET->USERS/:userId", () => {
    ...
    it("should have Array where items match PATTERN", () => {
      for (var i = 0; i < reply.body.length; i++) {
        ...
        reply.body[i].contentCreator = CC;
        reply.body[i].publicationId = PI
      }
    });
